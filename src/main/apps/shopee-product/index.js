...
import PricesChart from "main/apps/shopee-product/prices-chart";
import PricesTable from "main/apps/shopee-product/prices-table";

import { data } from "main/apps/shopee-product/data";
